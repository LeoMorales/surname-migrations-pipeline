...
def assign_origin_tag_to_popular_surnames_2015(upstream, product):
    ...
    Args:
        ...
        product (_type_):
            ...
            ---  ------                   --------------  -----
            0   surname                  50 non-null     object
            1   bearers                  50 non-null     int64
            2   division_bearer_ranking  50 non-null     int64
            3   division_level           50 non-null     object
            4   division_id              50 non-null     object
            5   year                     50 non-null     object
            6   classification           50 non-null     object
            dtypes: int64(2), object(5)
    """
    df = pandas.read_parquet(
        str(
            upstream["get-regional-bearers-rankings-2015"][
...
def assign_origin_tag_to_popular_surnames_2021(upstream, product):
    ...
    df = pandas.read_parquet(
        str(
            upstream["get-regional-bearers-rankings-2021"][
                "surnames-with-highest-number-of-bearers"
            ]
        )
    )
...
def assign_origin_label_to_single_bearer_surnames_2015(upstream, product):
    """Asigna una etiqueta de origen a aquellos apellidos que tienen un único portador en cada region de la Argentina.
