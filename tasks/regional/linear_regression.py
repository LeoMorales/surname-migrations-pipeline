import pandas
from surnames_package import utils, isonymic, models_utils
...
def get_linear_regression_params_2015(upstream, product):
    ...
    output_df = models_utils.compute_linear_regression_params_for_groups(
        df, division_id_column="region_id", division_name_column="region_nombre"
    )

    output_df["division_level"] = "region"
    output_df["year"] = "2015"
