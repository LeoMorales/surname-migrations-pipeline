...
def assign_origin_tag_to_popular_surnames_2015(upstream, product):
    ...
    Args:
        ...
        product (_type_):
            ...
            1   bearers                  240 non-null    int64
            2   division_bearer_ranking  240 non-null    int64
            3   division_level           240 non-null    object
            4   division_id              240 non-null    object
            5   year                     240 non-null    object
            6   classification           240 non-null    object
            dtypes: int64(2), object(5)
    """
    df = pandas.read_parquet(
        str(
            upstream["get-provincial-bearers-rankings-2015"][
...
def assign_origin_tag_to_popular_surnames_2021(upstream, product):
    ...
    df = pandas.read_parquet(
        str(
            upstream["get-provincial-bearers-rankings-2021"][
                "surnames-with-highest-number-of-bearers"
            ]
        )
    )
